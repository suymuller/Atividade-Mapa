				...
				<nav>
		         <ul>
		          <br><br><br>
		           ...
		           <li><a href="index.php?pg=1">Conheça a Dona Dirce</a></li>
		           <li><a href="index.php?pg=3">Contato</a></li>
		          </ul>
		        </nav>
			</div>
			<div id="logo2">
				<a href="?pg=1" ><img src="images/carne.jpg"><br></a>
			</div>
...
<br>
	<div id="footer">
		<div class="rodape_direito">
			...
			<p><a href="index.php?pg=1">Conheça a Dona Dirce</a></p>
		...
		<div class="rodape_esquerdo">
			...
			<div class="assinatura">
				...
				<p>
					Desenvolvido por Suyane Müller
				</p>
			</div>
